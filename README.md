...
See [docs/da-vinci-jr-setup.md](docs/da-vinci-jr-setup.md) for board-specific firmware setup, Duet WiFi wiring, and the proposed LPC1115 UART update design.
